...
static const b2Vec2 defaultGravity(0, .000000001);
//static const b2Vec2 defaultGravity(DEFAULT_WORLDSCALE, DEFAULT_WORLDSCALE);
...
void Scene::goRocketDown() {
	if (playerAvatar) {
		playerAvatar->goRocketDown();
	}
}



void Scene::goRocketUp() {
	if (playerAvatar) {
		playerAvatar->goRocketUp();
	}
}

void Scene::goRocketLeft() {
	if (playerAvatar) {
		playerAvatar->goRocketLeft();
	}
}


void Scene::goRocketRight() {
	if (playerAvatar) {
		playerAvatar->goRocketRight();
	}
}
